...
enum SKW_MIB_ID {
	...
	SKW_MIB_SET_RETRY_IGNORE_PROT = 58,
	...
	SKW_MIB_SET_RATE_CTRL_ER_DCM_RATE = 83,

	SKW_MIB_SET_CCA_EN = 130,
	...
	SKW_MIB_GET_PIN_VALUE_E = 207, //currently for nosie
...
#define SKW_CONN_FLAG_ASSOCED            (0)
#define SKW_CONN_FLAG_KEY_VALID          (1)
#define SKW_CONN_FLAG_USE_MFP            (2)
#define SKW_CONN_FLAG_AUTH_AUTO          (3)
#define SKW_CONN_FLAG_SAE_AUTH           (4)
...
struct skw_connect_param {
	...
	unsigned long flags; /* reference SKW_CONN_FLAG_ */
